...
import { FlaskConical, TrendingDown, TrendingUp, X } from 'lucide-react'
import { useEcoTrackStore } from '@/lib/store'
import { EmptyState } from '@/components/shared/empty-state'
import { cn } from '@/lib/utils'

export function SimulationPanel() {
  const { species, simulationResults, showSimulationResults, runSimulation, clearSimulation } = useEcoTrackStore()
